...
namespace ReleaseTools.UnitTests.InstallerManifestYaml
{
    public class InstallerManifestEntryGeneratorTests
    {
            ...
            InstallerManifestEntryGenerator sut)
        {
            ...
            A.CallTo(()=> extensionPackageNameGuesser.GetName( "2.3.4"))
                .Returns($"SparrowBrain_{Program.AddonName}_2_3_4.pext");
    ...
    PackageUrl: https://github.com/SparrowBrain/Playnite.{Program.AddonName}/releases/download/v2.3.4/SparrowBrain_{Program.AddonName}_2_3_4.pext
    Changelog:
      - Change 1
      - Change 22
      - Fix important!
